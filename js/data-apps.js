...
const USEFUL_APPS = [
  ...
  {slug:'pnp-asap', icon:'🛒', name:'Pick n Pay ASAP!', search:'Pick n Pay asap', desc:"Order grocery delivery", desc_ar:"طلب توصيل بقالة"},
  {slug:'pnp-smartshopper', icon:'🛍️', name:'Smart Shopper', search:'Smart Shopper Pick n Pay', desc:"Pick n Pay's rewards & shopping app", desc_ar:"تطبيق بيك أند باي للمكافآت والتسوق"},
